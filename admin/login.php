...
<head>
	<meta charset="utf-8" />
	<title>Siêu thị Tứ Sơn | 102 Nguyễn Tri Phương, P.Châu Phú B, TP.Châu Đốc, An Giang</title>
...
<body class="pace-top" style="background:#ffffcc;">
	<!-- begin #page-loader -->
        ...
        <div class="login login-with-news-feed">
            ...
            <div class="news-feed">
                ...
                <div class="news-caption">
                    ...
                    <i class="fa fa-shopping-cart fg-yellow"></i>
                    TỨ SƠN SUPERMARKET</h4>
                </div>
            </div>
            <!-- end news-feed -->
            <!-- begin right-content -->
            <div class="right-content">
                ...
                <div class="login-header">
                    <div class="brand">
                        <span class="fa fa-shopping-cart"></span> TỨ SƠN SUPERMARKET
                ...
                <div class="login-content">
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" class="margin-bottom-0" id="loginform">
                        ...
                        <div class="login-buttons">
                            <button type="submit" name="submit" id="submit" class="btn btn-danger btn-block btn-lg"><i class="fa fa-sign-in"></i> Đăng nhập hệ thống</button>
                        </div>
                        <hr />
                    </form>
                </div>
