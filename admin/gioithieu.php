...
$gioithieu = new GioiThieu(); $t = $gioithieu->get_one();
if(isset($_POST['submit'])){
    ...
    $gioithieu->banner = $arr_banner;
    $gioithieu->noidung = $noidung;
    if($gioithieu->edit()) transfers_to('gioithieu.html?msg=Lưu thành công');
}
?>
...
<!-- begin page-header -->
<h1 class="page-header">SIÊU THỊ TỨ SƠN - GIỚI THIỆU</h1>
