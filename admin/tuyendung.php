...
$tuyendung = new tuyendung(); $t = $tuyendung->get_one();
if(isset($_POST['submit'])){
    ...
    $tuyendung->banner = $arr_banner;
    $tuyendung->noidung = $noidung;
    $tuyendung->tieude = $tieude;
    if($tuyendung->edit()) transfers_to('tuyendung.html?msg=Lưu thành công');
}
?>
	...
	<div class="col-md-12">
		<div class="panel panel-danger">
            <div class="panel-heading">
                ...
                <h4 class="panel-title"><i class="fa fa-gears"></i> Nội dung TUYỂN DỤNG</h4>
            </div>
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        ...
                        <input class="form-control" type="text" id="tieude" name="tieude" placeholder="Tên danh mục tin tức" data-parsley-required="true" value="<?php echo isset($t['tieude']) ? $t['tieude'] : ''; ?>" />
                    </div>
                </div>
                <div class="form-group">
