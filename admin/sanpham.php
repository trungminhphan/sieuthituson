	...
	<div class="col-md-12">
		<div class="panel panel-danger">
            <div class="panel-heading">
                ...
                <h4 class="panel-title"><i class="fa fa-gears"></i> Danh sách sản phẩm của Siêu Thị</h4>
            </div>
            <div class="panel-body">
            <a href="themsanpham.html" class="btn btn-primary m-b-10" id="themmoi"><i class="fa fa-plus"></i> Thêm mới</a>
