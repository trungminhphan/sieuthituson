            ...
            <div class="panel-body">
                ...
                foreach($users_list as $ul){
                    ...
                    if($ul['roles'] & ADMIN){
                        ...
                        echo '<td><a href="users_delete.php?id='.$ul['_id'].'" onclick="return confirm(\'Chắc chắn xoá?\');"><i class="fa fa-trash-o"></i></a></td>';
                    }
                    echo '<td><a href="users_add.php?id='.$ul['_id'].'"><i class="fa fa-pencil"></i></a></td>';
                    echo '</tr>';
                    $i++;
                }
                ?>
