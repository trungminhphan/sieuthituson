...
$list = $nganhhang->get_all_list();
?>
<h1 class="page-header">TRANG CHỦ - DANH MỤC NGÀNH HÀNG</h1>
	...
	<div class="col-md-12">
		<div class="panel panel-danger">
            <div class="panel-heading">
                ...
                <h4 class="panel-title"><i class="fa fa-gears"></i> Danh mục Ngành hàng</h4>
            </div>
            <div class="panel-body">
            <a href="#modal-nganhhang" data-toggle="modal" class="btn btn-primary m-b-10" id="themmoi"><i class="fa fa-plus"></i> Thêm mới</a>
            <table id="data-table" class="table table-striped table-bordered table-hovered">
                ...
                if($list){
                	...
                	foreach ($list as $ds) {
                		...
                		echo '<td class="text-center"><a href="get.nganhhang.html?id='.$ds['_id'].'&act=del" onclick="return confirm(\'Chắc chắn muốn xóa?\')"><i class="fa fa-trash"></i></a></td>';
                        echo '<td class="text-center"><a href="get.nganhhang.html?id='.$ds['_id'].'&act=edit#modal-nganhhang" data-toggle="modal" class="suadanhmuc"><i class="fa fa-pencil"></i></a></td>';
                		echo '<tr>';$i++;
                	}
                }
                ?>
...
<!-- #modal-dialog -->
<div class="modal fade" id="modal-nganhhang">
<form action="post.nganhhang.html" method="POST" class="form-horizontal" data-parsley-validate="true" name="bannerform" id="bannerform" enctype="multipart/form-data">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title">Thông tin Ngành Hàng</h4>
            </div>
